                    ...
                    <table class="table table-a">
                        ...
                        <tbody>
                            <tr class="table align-middle container-fluid">
                                ...
                                <td class="col-2">
                                    <img src="assets/img/pizza.jpg" alt="" class="img-fluid img-max--w">
                            ...
                            <tr class="table align-middle container-fluid">
                                ...
                                <td class="col-2">
                                    <img src="assets/img/burger.jpg" alt="" class="img-fluid img-max--w">
                            ...
                            <tr class="table align-middle container-fluid">
                                ...
                                <td class="col-2">
                                    <img src="assets/img/momo.jpg" alt="" class="img-fluid img-max--w">
                                </td>
                                <td class="col-1">
                                    Yes
                            ...
                            <tr class="table align-middle container-fluid">
                                ...
                                <td class="col-2">
                                    <img src="assets/img/bg.jpg" alt="" class="img-fluid img-max--w">
                                </td>
                                <td class="col-1">
                                    No
                                </td>
